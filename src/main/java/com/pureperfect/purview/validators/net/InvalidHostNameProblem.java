...
/**
 * Indicates that a host name is not valid.
 * 
 * @author J. Chris Folsom
 * @version 1.1
 * @since 1.0
 */
public class InvalidHostNameProblem extends
		ValidationProblem<Object, Annotation, Object, CharSequence>
{
	InvalidHostNameProblem(final Object instance, final Annotation annotation,
