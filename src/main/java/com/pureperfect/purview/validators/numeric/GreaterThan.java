...
/**
 * Specify that a java.lang.Number (or a subclass) should be greater than a
 * given number.
 * 
 * <p>
 * E.G:
 ...
 *  public static void foo(&#64;GreaterThan(5) Integer bar) {
 *    ...
 *  }
 * }
 * </pre>
...
{
	/**
	 * Indicates that the value was not greater than the required value.
	 * 
	 * @author J. Chris Folsom
	 * @version 1.1
	 * @since 1.0
	...
	public class Problem extends
			ValidationProblem<Object, GreaterThan, Object, Number>
	{
		Problem(final Object instance, final GreaterThan annotation,
	...
	public class Validator
			implements
			com.pureperfect.purview.Validator<Problem, Object, GreaterThan, Object, Number>
	{
        /**
         * {@inheritDoc}
         */
		public Problem validate(final Object instance,
				final GreaterThan annotation, final Object target,
				final Number number)
		{
			if (number == null)
			{
	...
	/**
	 * The {@link GreaterThan.Validator Validator} for this annotation.
	 * 
	 * @return The {@link GreaterThan.Validator} class
	 */
	Class<?> validator() default Validator.class;

	/**
	 * Specify what the value must be greater than.
	 * 
	 * @return what the value must be greater than.
	 */
	double value();
}