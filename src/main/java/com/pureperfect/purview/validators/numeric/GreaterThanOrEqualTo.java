...
/**
 * Specify that a java.lang.Number (or a subclass) should be greater than or
 ...
 *  public static void foo(&#64;GreaterThanOrEqualTo(5) Integer bar) {
 *    ...
 *  }
 * }
 * </pre>
...
{
	/**
	 * Indicates that the value was not greater than or equal to the required
	 * number.
	 * 
	 * @author J. Chris Folsom
	 * @version 1.1
	...
	public class Problem extends
			ValidationProblem<Object, GreaterThanOrEqualTo, Object, Number>
	{
		Problem(final Object instance, final GreaterThanOrEqualTo annotation,
	...
	public class Validator
			implements
			com.pureperfect.purview.Validator<Problem, Object, GreaterThanOrEqualTo, Object, Number>
	{
        /**
         * {@inheritDoc}
         */
		public Problem validate(final Object instance,
				final GreaterThanOrEqualTo annotation, final Object target,
				final Number number)
		{
			if (number == null)
			{
	...
	/**
	 * The {@link GreaterThanOrEqualTo.Validator Validator} for this annotation.
	 * 
	 * @return The {@link GreaterThanOrEqualTo.Validator} class
	 */
	Class<?> validator() default Validator.class;

	/**
	 * Specify what the value must be greater than or equal to.
	 * 
	 * @return what the value must be greater than or equal to.
	 */
	double value();
}