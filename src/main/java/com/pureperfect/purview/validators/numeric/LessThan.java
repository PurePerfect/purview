...
/**
 * Specify that a java.lang.Number (or a subclass) should be less than a given
 * number.
 * 
 * <p>
 * E.G:
 ...
 *  public static void foo(&#64;LessThan(5) Integer bar) {
 *    ...
 *  }
 * }
 * </pre>
...
{
	/**
	 * Indicates that the value was not less than the specified value.
	 * 
	 * @author J. Chris Folsom
	 * @version 1.1
	 * @since 1.0
	...
	public class Problem extends
			ValidationProblem<Object, LessThan, Object, Number>
	{
		Problem(final Object instance, final LessThan annotation,
	...
	/**
	 * Specify that a java.lang.Number (or a subclass) should be less than a
	 * given number.
	 * 
	 * @author J. Chris Folsom
	 * @version 1.1
	...
	public class Validator
			implements
			com.pureperfect.purview.Validator<Problem, Object, LessThan, Object, Number>
	{
        /**
         * {@inheritDoc}
         */
		public Problem validate(final Object instance,
				final LessThan annotation, final Object target,
				final Number number)
		{
			if (number == null)
			{
	...
	/**
	 * The {@link LessThan.Validator Validator} for this annotation.
	 * 
	 * @return The {@link LessThan.Validator} class
	 */
	Class<?> validator() default Validator.class;

	/**
	 * Specify what the value must be less than.
	 * 
	 * @return what the value must be less than.
	 */
	double value();
}