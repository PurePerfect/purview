...
/**
 * Ensure that all of the characters in the string are upper case.
 * 
 * <p>
 * E.G:
 * </p>
 ...
 *  public static void foo(&#64;UpperCase String bar) {
 *    ...
 *  }
 * }
 * </pre>
...
{
	/**
	 * Indicates that the specified value was not upper case.
	 * 
	 * @author J. Chris Folsom
	 * @version 1.3
	 * @since 1.3
	...
	public class Problem extends
			ValidationProblem<Object, UpperCase, Object, CharSequence>
	{
		Problem(final Object instance, final UpperCase annotation,
	...
	/**
	 * Validate that all of the characters in the string are upper case.
	 * 
	 * @author J. Chris Folsom
	 * @version 1.3
	 * @since 1.3
	...
	public class Validator
			implements
			com.pureperfect.purview.Validator<Problem, Object, UpperCase, Object, CharSequence>
	{
        /**
         * {@inheritDoc}
         */
	...
	/**
	 * The {@link UpperCase.Validator Validator} for this annotation.
	 * 
	 * @return the {@link UpperCase.Validator} class
	 */
