...
/**
 * Unit test for {@link True} annotation.
 * 
...
public class TrueTest extends TestCase
{
	...
	public class Stub
	{
		...
		public void foo(@True Boolean bar)
		{
			// blah
		}
	}
	 ...
	 * Test valid value.
	 */
	public void testParameterIsValid() throws Exception
	{
		Stub stub = new Stub();
	 ...
	 * Test invalid value.
	 */
	public void testParameterIsNotValid() throws Exception
	{
		Stub stub = new Stub();
