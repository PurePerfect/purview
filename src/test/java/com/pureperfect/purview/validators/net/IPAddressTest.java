...
/**
 * Unit test for {@link IPAddress} annotation.
 * 
...
public class IPAddressTest extends TestCase
{
	...
	{
		@IPAddress
		public String field = "123.123.123.123";

		@IPAddress(required = true)
		public String required = "123.123.123.123";
		...
		public void paramTest(@IPAddress final String address)
		{
			// for testing
		}
	...
	public void testRequired() throws Exception
	{
		...
		mock.required = "255.255.255.255";

		assertEquals(0,
				Purview.validateFields(mock, new MakeAccessibleFieldFilter())
						.getProblems().size());

		mock.required = "256.256.256.256";
