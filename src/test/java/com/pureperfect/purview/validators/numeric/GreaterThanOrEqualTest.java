...
/**
 * Unit test for {@link GreaterThanOrEqualTo} annotation.
 * 
...
public class GreaterThanOrEqualTest extends TestCase
{
	public class Stub
	{
		...
		@GreaterThanOrEqualTo(value = 5, required = true)
		...
		public void paramTest(@GreaterThanOrEqualTo(25) final Long id)
		{
			// for testing
		}
