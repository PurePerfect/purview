...
/**
 * Unit test for {@link Regex} annotation.
 * 
...
public class RegexTest extends TestCase
{
	public class Stub
	{
		...
		public void foo(@Regex("[a-z]*") String bar)
		{
			// test method
		}
	}
	...
	public void testParameters() throws Exception
	{
		...
		assertEquals(1, Purview.validateParameters(mock, m, new Object[] {"woot9"}).getProblems().size());
